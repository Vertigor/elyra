...
- A Kubernetes Cluster without Apache Airflow installed
    ...
    - Helm v3.0 or later
    - Use the [Helm chart](https://github.com/airflow-helm/charts/tree/main/charts/airflow) available in the Airflow source distribution with the [Elyra sample configuration](https://gitlab.js.sgcc.com.cn/elyra-ai/elyra/raw/master/etc/kubernetes/airflow/helm/values.yaml).
...
2. Download, review, and customize the [sample `helm` configuration](https://gitlab.js.sgcc.com.cn/elyra-ai/elyra/raw/master/etc/kubernetes/airflow/helm/values.yaml) (or customize an existing configuration):
